(function (root, factory) {
    ...
    echarts.registerMap('肯尼亚', {
        ...
        "features": [{
            ...
            "geometry": {"type": "Polygon", "coordinates": ["@@İɭDïºď[īŃß[CćĜoÈƎΚ"], "encodeOffsets": [[38204, -155]]}
        }, {
            "type": "Feature",
            ...
            "geometry": {
                "type": "MultiPolygon",
                "coordinates": [["@@î­ì"], ["@@ʂņͤǆ֔´ƥǹĕÁ¿ÃÁƍã{±ÆhǹNđ§pqÓ®OÄË÷ÏQAÁOǷÄ¡{¯āD@ŰǶ"]],
            ...
            "geometry": {
                "type": "MultiPolygon",
                "coordinates": [["@@ĭ\\]j{Ģa"], ["@@MýzƃHƩċëĳ©¹©IŧéƙëmőRɉt·ƉćΓȫƷͧ˃LľĉÒSǑyõAéŸĭƲ¯t}ĬDÃ²UűjāEĖÍŮïȮĹğÆàcǤnqżûBÏrćÚŢÙ¼§Ÿ£ǌ^ŐÎüĉƼÀǌŴKƌЀSƐPƾÉĘñ̪ȣǦũʊƳŘĻ¼\\ɐcĒzðUȮåĪCÈ|Ĕ½ÚO°t"]],
            ...
            "geometry": {"type": "Polygon", "coordinates": ["@@âÊĮķǓ×Ɗ"], "encodeOffsets": [[40519, -4089]]}
        }, {
            "type": "Feature",
