(function (root, factory) {
    ...
    echarts.registerMap('埃及', {
        ...
        "features": [{
            ...
            "geometry": {
                "type": "MultiPolygon",
                "coordinates": [["@@ļA@íz×gý¥²­tĝ[KÇ§EöT½±GćŁBʵ_úĪE¨£`ĒKÖTðCg¢V²ÞMĊVƆ"], ["@@ÈPżî²cεhĎĩđȱ@õQºÙÄƠhĄĴGÒ"]],
            ...
            "geometry": {
                "type": "MultiPolygon",
                "coordinates": [["@@ÀبDȲȨʶ`łAĈ²H¾£Tř^áe{áQw«¦oË¹¯åH§o±Î¾Ã¼t^ÉlvķÝV¹Uµƭ¯ƇűQŃj"], ["@@Ȳ@tÃEǕzÑuƗ÷Dº§¤JÆ_üBŜ"]],
